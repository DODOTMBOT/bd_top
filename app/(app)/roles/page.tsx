    ...
    <div className="container max-w-6xl py-8 space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-default-500 mt-1">Выберите раздел для работы</p>
        </div>

        <Badge content={role} color="primary" variant="flat">
          <div className="min-w-[220px] p-4 bg-content2 rounded-lg">
          ...
          <Card key={t.href} className="hover:shadow-md transition-shadow" isPressable as={Link} href={t.href}>
            <CardHeader className="flex flex-row items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-default-500">{t.desc}</span>
              </div>
            </CardHeader>
            <CardBody>
      ...
      <Card className="bg-content2 border-dashed">
        <CardBody>
          <div className="flex flex-wrap items-center gap-3">
            <span className="text-sm text-default-500">Быстрые действия:</span>
